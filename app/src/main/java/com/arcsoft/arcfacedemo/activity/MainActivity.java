...
import com.arcsoft.arcfacedemo.ztrs.WindowWebFragment;
import com.arcsoft.arcfacedemo.ztrs.ZpImageUtils;
import com.arcsoft.arcfacedemo.ztrs.ZpWebChromeClient;
import com.arcsoft.arcfacedemo.ztrs.ZpWebView;
...
//        webView.loadData(htmlSrc, "text/html", "UTF-8");
        webView.loadUrl("http://tool.jjaq.com.cn/ftool/");
    }
    ...
    public void takeCameraPhoto() {
        ...
        if (!EasyPermissions.hasPermissions(this, Manifest.permission.CAMERA,
            ...
            if (getApplicationInfo().targetSdkVersion > Build.VERSION_CODES.M) {
                String authority = "com.arcsoft.arcfacedemo.ztrs.UploadFileProvider";

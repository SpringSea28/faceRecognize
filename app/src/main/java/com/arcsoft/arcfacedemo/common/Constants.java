...
public class Constants {
    ...
    public static final String APP_ID = "5VPYoGeHxw6njYJ6q4eQjgiQLY2h6eMb5WLpTNBwi3WB";
    public static final String SDK_KEY = "7JzR5jnJPPpdiu8Y5EedVbKEnaxVXcsUnKVcb2YmZ4ev";
